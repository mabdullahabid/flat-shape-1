"""
Django settings for flat_shape_1 project.
...
ROOT_URLCONF = 'flat_shape_1.urls'
...
WSGI_APPLICATION = 'flat_shape_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "flat_shape_1 API",
    "DESCRIPTION": "API documentation for flat_shape_1 App",
    "VERSION": "v1",
}
